...
public abstract class Registro {
    ...
    public static List<Locacao> lLocacoes = new ArrayList<Locacao>(Arrays.asList(new Locacao []{
        new LocacaoDiaria(new Date(2012,05,04),new Date(2012,06,09),3.000f,Registro.lCarros.get(1),10),
        new LocacaoDiaria(new Date(2012,06,08),new Date(2012,12,09),2.800f,Registro.lCarros.get(2),10),
        new LocacaoDiaria(new Date(2012,16,08),new Date(2012,24,09),1.800f,Registro.lCarros.get(3),10),
        new LocacaoDiaria(new Date(2012,16,08),new Date(2012,24,09),1.800f,Registro.lCarros.get(4),10),
        new LocacaoDiaria(new Date(2012,16,08),new Date(2012,24,09),1.800f,Registro.lCarros.get(4),10)
    }));
