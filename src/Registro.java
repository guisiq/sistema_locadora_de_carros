...
public abstract class Registro {
    ...
    public static List<Locacao> lLocacoes = new ArrayList<Locacao>(Arrays.asList(new Locacao[]{
        ...
        new Locacao(3,"06/08/2012","12/09/2012",2.800,60.000, new Carro(2, "KEQ-0424", new Date(2009, 10, 7) , 1993, "Corolla DX/ SW DX 1.6 16V", Cor.LARANJA,Categoria.POPULAR)),
        new Locacao(4,"16/08/2012","24/09/2012",1.800,69.000, new Carro(3, "KIO-0964", new Date(2004, 10, 7) , 1993, "Corolla DX/ SW DX 1.6 16V", Cor.AZUL,Categoria.POPULAR)),
        new Locacao(4,"16/08/2012","24/09/2012",1.800,69.000, new Carro(4, "MNG1163", new Date(2010,06,5) ,1994, "Espero 2.0", Cor.MARROM,Categoria.POPULAR)),
    }));
